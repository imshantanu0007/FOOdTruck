...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a href="login.php">Fruits & Vegetables</a>
    <a href="login.php">Foodgrains,Oil & Masala</a>
    <a href="login.php">Bakery & Dairy</a>
  </div>
</div></th>
<th><div class="tab">
  <button class="tablinks" onclick="location.href='offers.php';">Offers</button>
  <button class="tablinks" onclick="location.href='delivery.php#del';">Delivery Express</button>
  <button class="tablinks" onclick="location.href='delivery.php#spe';">Specialities</button>
  <button class="tablinks" onclick="location.href='login.php';">New Launches</button>
   <button class="tablinks" onclick="location.href='offers.php';">Deals of the Week</button>
</div></th>
</tr></table>
<hr/>
...
<th><a href="offers.php#c20"><img src="pics\cp.png" border="2"></a></th>
<th><a href="offers.php#p150"><img src="pics\pp.png" border="2"></a></th>
<th><a href="offers.php#f50"><img src="pics\fp.png" border="2"></a></th>
<th><a href="offers.php"><img src="pics\vp.png" border="2"></a></th>
</div>
</tr>
</table>
</body>
